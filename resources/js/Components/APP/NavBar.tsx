                ...
                <div className="flex min-w-[40%] items-center justify-end">
                    <div className="relative w-full max-w-xs md:max-w-sm">
                        ...
                        <input
                            type="search"
                            placeholder="Search..."
                            className="w-full rounded-lg border border-gray-300 bg-black/70 py-2 pl-10 pr-4 text-sm text-gray-100 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:placeholder-gray-500"
                        />
                    </div>
